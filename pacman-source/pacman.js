    ...
    function init(wrapper, root) {
        ...
        dialog("Loading ...");
			...
			async function loadAudioFiles() {
				...
				try {
					await Promise.all(
							audioFiles.map(([name, path]) => audio.loadSound(name, path))
					);
					loaded(); // Call your loaded function when done
				} catch (error) {
			...
			// Call this instead of the old load function
			loadAudioFiles();
    };
